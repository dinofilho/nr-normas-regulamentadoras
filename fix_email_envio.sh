...
# 1) Regrava quiz.html com seu endpoint Formspree
cat > quiz.html <<'EOF'
...
<main class="max-w-4xl mx-auto p-6">
  ...
  <!-- Endpoint Formspree (seu ID real) -->
...
# 2) Regrava a lógica com AJAX + fallback por <form> POST
...
echo "✓ Arquivos atualizados. Fazendo commit e push..."
git add quiz.html assets/js/quiz.js
git commit -m "Envio por e-mail robusto (AJAX + fallback form) e endpoint Formspree aplicado"
git push
echo "✅ Pronto! Recarregue o quiz (Ctrl+F5) e teste o botão 'Enviar para meu e-mail'."
